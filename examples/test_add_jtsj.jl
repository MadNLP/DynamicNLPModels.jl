...
x     = rand(size(J, 1))
xcuda = CuArray{Float64}(undef, length(x))
copyto!(xcuda, x)

jtsj_mul!(H, J, x, ΣJ)
add_jtsj!(Hcuda, J_cu_imp, xcuda, 1, 1)
...
ns_vals = [10, 30, 50, 80, 250, 500, 2000, 4000, 6000]
nu = 10
N  = 50
add_ns_cuda  = []
add_ns_cuda2 = []
